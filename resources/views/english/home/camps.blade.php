...
<head>
    ...
    <!-- style CSS -->
    <link href="{{asset('assets')}}/css/camps.css" rel="stylesheet" type="text/css">


    <title>Father & Child Camps</title>
        ...
        <header id="nav">
                        ...
                        <a class="navbar-brand" href="{{route('en.home.index')}}">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav nav-pills ml-auto justify-content-end">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ar/camps-ar.html">عربي</a>
                                    </li>
                                </ul>
            ...
            <section id="title">
                <div class="container text-center ">
                    <h1 data-aos="zoom-out" data-aos-delay="0" data-aos-duration="1000">Father & Child Camps</h1>
                </div>
